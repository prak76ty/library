...
Public Class supplyermaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lib_mgt.supplyermaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsupplyermaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As supplyermaster = New supplyermaster
        rpt.Site = Me.Site
        Return rpt
    End Function
