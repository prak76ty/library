...
Public Class rpt_book_acce
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lib_mgt.rpt_book_acce.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_book_acce
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_book_acce = New rpt_book_acce
        rpt.Site = Me.Site
        Return rpt
    End Function
