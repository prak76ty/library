...
Public Class rptmemberdetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lib_mgt.rptmemberdetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptmemberdetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptmemberdetail = New rptmemberdetail
        rpt.Site = Me.Site
        Return rpt
    End Function
