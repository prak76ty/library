...
Public Class rptOrderMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lib_mgt.rptOrderMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOrderMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrderMaster = New rptOrderMaster
        rpt.Site = Me.Site
        Return rpt
    End Function
