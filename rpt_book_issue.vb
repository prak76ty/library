...
Public Class rpt_book_issue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lib_mgt.rpt_book_issue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_book_issue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_book_issue = New rpt_book_issue
        rpt.Site = Me.Site
        Return rpt
    End Function
